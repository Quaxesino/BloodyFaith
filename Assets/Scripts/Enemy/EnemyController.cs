...
public enum EnemyStates { Idle, CombatMovementState, Attack,RetreatAfterAttack, Dead, GettingHit}
...
public class EnemyController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        stateDict[EnemyStates.CombatMovementState] = GetComponent<CombatMovementState>();
    ...
    public void AlertNearbyEnemies()
    {
        ...
        foreach (var collider in colliders)
        {
            ...
            if (nearbyEnemy != null && nearbyEnemy.Target == null)
            {
                ...
                nearbyEnemy.ChangeState(EnemyStates.CombatMovementState);
            }
        }
    }
